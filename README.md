...
colcon build --packages-select vortex_blackfly_driver

### Run

### Default serial for one of our cameras
ros2 launch vortex-blackfly-driver blackfly_s.launch.py serial:="'23494258'"
